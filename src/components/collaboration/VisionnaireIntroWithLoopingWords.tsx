  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (wordListRef.current) {
        ...
        wordsTl.call(moveWords).to({}, { duration: interval / 1000 }).repeat(-1);
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          <h2 ref={quoteRef} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif leading-tight">
  Where <span className="text-[#c5a267]">Innovation</span> Meets{" "}
  <span className="text-[#c5a267]">Tradition</span>
</h2>
<h3 ref={subtitleRef} className="text-lg sm:text-xl md:text-2xl text-black font-light tracking-wide">
  Redefining Luxury Living in New York
</h3>
<p ref={paragraphRef} className="text-base sm:text-lg text-gray-800 leading-relaxed font-light">
  Our exclusive collaboration with Visionnaire represents the pinnacle of 
  Italian craftsmanship and contemporary luxury interior design. 
  Each piece is a testament to our shared commitment to excellence, blending 
 traditional artisanal techniques with modern innovation 
