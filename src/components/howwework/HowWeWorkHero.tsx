...
const HowWeWorkHero: React.FC<HowWeWorkHeroProps> = ({ scrollToTimeline }) => {
  ...
  useEffect(() => {
    ...
    if (!audioElement) {
      ...
      audioElement.src = 'https://res.cloudinary.com/dnddesigncenter/video/upload/vqc96je5f2n2hnsj8tw06o.mp3';
